...
const Footer = () => {
  ...
  return (
    <div>
      <footer className="dark:bg-gray-950 border-t  border-gray-300 dark:border-gray-800 bg-gray-100 py-6 font-sans tracking-wide">
        <div className="max-w-[1300px]  mx-auto px-5 flex max-lg:flex-col items-center justify-between gap-x-6 gap-y-8">
        <ul className="flex flex-wrap justify-center gap-6">
          ...
          <li>
            <a href='https://x.com/MD_Saroar_Jahan' target="_blank">
          ...
          <p className="text-base text-center dark:text-gray-100 text-gray-700 max-lg:order-1">
            © {date.getFullYear()} Saroar Jahan. All rights reserved.
          </p>
